...
[deployment_meta_all, sensors_all] = get_deployment_metadata('PLATFORM_NUMBER=1902303');
...
[sensor_meta, api_call, status] = get_sensor_metadata('SENSOR=FLUOROMETER_CHLA', fields);
